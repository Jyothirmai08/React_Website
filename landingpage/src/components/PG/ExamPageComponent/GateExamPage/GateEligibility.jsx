  ...
  return (
    <div>
        <ul>
            ...
            <li>As per the revised GATE eligibility criteria, you must have a minimum qualification of 10+2+3. In the final year of graduation, candidates are also eligible to apply for the GATE entrance examination. Candidates pursuing or have passed their graduation in either Engineering, Technology, Architecture, Science, Commerce or Arts in a relevant discipline can apply for the course.</li>

            <p><b>Pass Percentage</b></p>

            <li>No minimum pass percentage criteria are defined to apply for the GATE exam 2023.</li>

            <p><b>Age Limit</b></p>

            <li>There is no age limit defined to apply for the GATE exam 2023.</li>

            <p><b>Nationality</b></p>
            <li>You should have Indian nationality to apply for GATE 2023. Candidates from Nepal, Bangladesh, Singapore, Sri Lanka, Ethiopia, and the United Arab Emirates are also eligible for the GATE.</li>

            <p><b>GATE Eligibility Criteria for International Students</b></p>
            <li>Candidates living in Nepal, Bangladesh, Singapore, Sri Lanka, Ethiopia, and the United Arab Emirates are eligible to apply for GATE. Candidates from these countries must have completed or be in their final year or the pre-final year of their bachelor's degree in engineering and technology or equivalent.</li>
...
export default GateEligibility